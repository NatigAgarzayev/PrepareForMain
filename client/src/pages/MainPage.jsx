...
function MainPage() {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-0 md:gap-5 calc__height dark:bg-gray-600'>
            <div className='absolute flex sm:hidden gap-3 bottom-5 right-5 z-40'>
                <button className='w-12 outline-none h-12 relative bg-gray-900 dark:bg-white rounded-full' onClick={handlePrev}>
                    <svg className='w-6 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 fill-white dark:fill-black' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" /></svg>
                </button>
                <button className='w-12 outline-none h-12 relative bg-gray-900 rounded-full' onClick={handleNext}>
