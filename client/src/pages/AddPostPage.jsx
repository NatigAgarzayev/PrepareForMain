                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            ...
                            <div className="flex flex-col-reverse w-full">
                                ...
                                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                    ...
                                    <input ref={inp} onChange={e => { setImage(e.target.files[0]); setCanceled(false) }} id="dropzone-file" type="file" className="hidden" />
                                </label>
                            </div>
                            {
                                image && !canceled && (<button type='button' onClick={handleCancel} className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cancel</button>)
                            }
                        </div>
                    </div>
                    <div className="relative z-0 w-full mb-6 group">
